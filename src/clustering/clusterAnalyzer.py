...
class ClusterAnalysis:
    ...
    def plot_purity_distribution(self, n_bins = 20, labels = ["Actual", "Permuted"]):
        ...
        plt.savefig("../results/figures/purity_distribution.pdf", format='pdf', dpi=1200)
        plt.show()
    ...
    def cluster_quality_classifier(self, n_folds = 10, feat_importances = True):
        ...
        if feat_importances is True:
            ...
            fig.savefig("../results/figures/cluster_quality_classifier_feature_importances.pdf",
                        format='pdf', dpi=1200)
            plt.show()
    ...
    def cluster_quality_regressor(self, feat_importances = True):
        ...
        if feat_importances is True:
            ...
            ax.set_ylabel("")
            ax.set_title("Feature importance - VDJdb", fontsize=26)
            fig.savefig("../results/figures/cluster_quality_regressor_feature_importances.pdf",
                        format='pdf', dpi=1200)
            plt.show()
