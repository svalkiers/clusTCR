from clustcr.input.vdjdb import vdjdb_to_cdr3list, vdjdb_to_gliph2, vdj_to_tcrdist, vdjdb_to_epitopedata
from clustcr.input.immuneaccess import construct_metarepertoire, immuneACCESS_to_cdr3list
from clustcr.input.tools import path_in_data
...
def metarepertoire_gliph2(n_sequences=10 ** 6, directory=path_in_data('immuneACCESS')):
    return construct_metarepertoire(directory, n_sequences=n_sequences)


def metarepertoire_tcrdist(n_sequences=10 ** 6, directory=path_in_data('immuneACCESS')):
