[![Documentation Status](https://readthedocs.org/projects/clustcr/badge/?version=latest)](https://clustcr.readthedocs.io/en/latest/?badge=latest)
...
You can retrieve CDR3 sequences from the VDJdb by importing the following functions from the `datasets` module:
